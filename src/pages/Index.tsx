        ...
        <SignedOut>
          <div className="flex items-center justify-center min-h-[80vh]">
            <div className="text-center">
              <h2 className="text-3xl font-bold text-gray-800 mb-4">Welcome to Shikshasetu-AI</h2>
              <p className="text-gray-600 mb-8">Please sign in to upload your resume and get personalized career guidance</p>
              <SignInButton mode="modal">
