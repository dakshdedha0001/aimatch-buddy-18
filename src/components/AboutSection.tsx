...
export const AboutSection: React.FC = () => {
  return (
    <footer className="mt-32 border-t border-gray-200/60">
      ...
      <div className="py-20 px-6 bg-white">
        <div className="max-w-5xl mx-auto text-center space-y-12">
          ...
          <div className="flex flex-wrap items-center justify-center gap-6">
            <Button variant="outline" className="bg-white hover:bg-blue-50 border-gray-300 hover:border-blue-500 px-8 py-4 text-base font-semibold rounded-full transition-all duration-300 hover:shadow-lg text-gray-900">
            ...
            <Button variant="ghost" className="text-gray-800 hover:text-blue-600 hover:bg-blue-50 px-8 py-4 text-base font-semibold rounded-full transition-all duration-300">
              About This Demo
            </Button>
          </div>
          ...
          <div className="flex items-center justify-center space-x-6">
            <Button variant="ghost" size="icon" className="w-12 h-12 rounded-full hover:bg-blue-100 hover:text-blue-600 transition-all duration-300 text-gray-700">
      ...
      <div className="py-6 px-6 bg-gray-50 border-t border-gray-200">
